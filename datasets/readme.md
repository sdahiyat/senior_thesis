The full datasets used to train and evaluate the model are too large to upload to GitHub. Instead, I have included smaller example files that illustrate the structure and format of each dataset.
